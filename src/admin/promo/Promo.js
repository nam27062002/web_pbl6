        ...
        <div className="container-content-history pb-2">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="w-50 px-4 mt-1">
                    ...
                    <div className="">
                        <label htmlFor="code" className='text-light'>Code:</label>
                        <input
                            type="text"
                            id="code"
                            name="code"
                    ...
                    <div className="">
                        <label htmlFor="discount" className='text-light'>Discount (%):</label>
                        <input
                            type="number"
                            id="discount"
                            name="discount"
                    ...
                    <div className="">
                        <label htmlFor="image" className='text-light'>Image URL:</label>
                        <input
                            type="text"
                            id="image"
                            name="image"
                ...
                <div className="w-50 px-4 mt-2">
                    ...
                    <div className="">
                        <label htmlFor="type" className='text-light'>Type:</label>
                        <select
                            id="type"
                            name="type"
                    ...
                    <div className="">
                        <label htmlFor="startDate" className='text-light'>Start Date:</label>
                        <input
                            type="date"
                            id="startDate"
                            name="startDate"
                    ...
                    <div className="">
                        <label htmlFor="endDate" className='text-light'>End Date:</label>
                        <input
                            type="date"
                            id="endDate"
                            name="endDate"
