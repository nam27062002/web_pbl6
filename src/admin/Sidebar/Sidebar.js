    ...
    return (
        <div className="collapse d-lg-block sidebar collapse sidebar-container fixed-bottom">
            <ul className="sidebar-list">
                ...
                <li>
                    <a href="#" className={activeItem === 'Drivers' ? 'active_item' : ''} onClick={() => handleItemClick('Drivers')}>
                        <img src="images/driver.png" className="sidebar-icon" />
                        <span className="text-light">Drivers</span> 
                    </a>
                </li>
                <li>
                    <a href="#" className={activeItem === 'Help Desk' ? 'active_item' : ''} onClick={() => handleItemClick('Help Desk')}>
                        <img src="images/support.png" className="sidebar-icon" />
                        <span className="text-light">Help Desk</span> 
                    </a>
                </li>
                <li>
                    <a href="#" className={activeItem === 'Create Promo' ? 'active_item' : ''} onClick={() => handleItemClick('Create Promo')}>
